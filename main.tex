...
Betrachte eine beschränkte Folge $(\varphi_n)_{n \in \mathbb{N}} \subset \h'$, mit $\Vert \varphi_n - \varphi_m \Vert_{\h'} \leq M$ für alle $n,m \in \mathbb{N}$. Da $K^\ast$ beschränkt ist hat $(KK^\ast\varphi_n)_{n \in \mathbb{N}} \subset \h'$ eine konvergente Teilfolge $(KK^\ast\varphi_{n_k})_{n \in \mathbb{N}}$. Es gilt nun mittels Skalarprodukt
\begin{align}
...
\end{align}
Also ist $(K^\ast \varphi_{n_k})_{k \in \mathbb{N}}$ eine Cauchy-Folge in einem Hilbertraum und aufgrund von dessen Vollständigkeit auch konvergent. Also hat $(K^\ast \varphi_{n})_{n \in \mathbb{N}}$ eine konvergente Teilfolge für jede beschränkte Folge $(\varphi_n)_{n \in \mathbb{N}} \subset \h'$, weshalb $K^\ast$ kompakt ist.
\end{proof}
